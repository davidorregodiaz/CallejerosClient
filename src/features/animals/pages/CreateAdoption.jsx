...
export function CreateAdoption() {
  ...
  const tagClass = (selected) =>
    `cursor-pointer rounded-full px-3 py-1.5 text-sm border ${selected
      ? "bg-primary/30 border-primary"
      : "border-border-light bg-background-light dark:bg-background-dark text-text-light"
    } transition-colors`;

  const successMessage = {
    title: "Animal en adopcion",
    message: "La adopcion ha sido creada satisfactoriamente"
  };

  return (
    <>
      {success && <SuccessToast data={successMessage} />}
      {loading && <Spinner />}
      {error && <ErrorToast errorMessage={"Ocurrio un error al crear la adopcion"} />}
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div className="relative hover:bg-primary/30 transition-colors">
                    ...
                    />
                    <label
                      className={`flex cursor-pointer items-center justify-center rounded-lg p-3 text-center text-sm border  ${form.size === "Small"
                        ? "bg-primary/30 border-primary"
                        : "border-border-light"
                        }`}
                      htmlFor="size-small"
                  ...
                  <div className="relative hover:bg-primary/30 transition-colors">
                    ...
                    />
                    <label
                      className={`flex cursor-pointer items-center justify-center rounded-lg p-3 text-center text-sm border  ${form.size === "Medium"
                        ? "bg-primary/30 border-primary"
                        : "border-border-light"
                        }`}
                      htmlFor="size-medium"
                  ...
                  <div className="relative hover:bg-primary/30 transition-colors">
                    ...
                    />
                    <label
                      className={`flex cursor-pointer items-center justify-center rounded-lg p-3 text-center text-sm border  ${form.size === "Big"
                        ? "bg-primary/30 border-primary"
                        : "border-border-light"
                        }`}
                      htmlFor="size-large"
                ...
                <div className="mt-3">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="relative hover:bg-primary/30 transition-colors">
                      ...
                      />
                      <label
                        className={`flex cursor-pointer items-center justify-center rounded-lg p-3 text-center text-sm border ${form.gender === "Male"
                          ? "bg-primary/30 border-primary"
                          : "border-border-light"
                          }`}
                        htmlFor="gender-male"
                    ...
                    <div className="relative hover:bg-primary/30 transition-colors">
                      ...
                      />
                      <label
                        className={`flex cursor-pointer items-center justify-center rounded-lg p-3 text-center text-sm border ${form.gender === "Female"
                          ? "bg-primary/30 border-primary"
                          : "border-border-light"
                          }`}
                ...
                <div className="flex flex-col gap-4 mt-1">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="relative">
                      ...
                      />
                      <label
                        className={`cursor-pointer rounded-full px-3 py-1.5 text-sm border hover:bg-primary/30 ${form.isDewormed
                          ? "bg-primary/30 border-primary"
                    ...
                    <div className="relative">
                      ...
                      />
                      <label
                        className={`cursor-pointer rounded-full px-3 py-1.5 text-sm border hover:bg-primary/30 ${form.isSterilized
                          ? "bg-primary/30 border-primary"
                          : "border-border-light bg-background-light"
                          }`}
                        htmlFor="sterilized"
