      ...
      <div className="flex items-start gap-4 rounded-lg bg-white p-4 shadow-lg ring-1 ring-black ring-opacity-5 font-display">
        <div className="shrink-0">
          <div className="flex h-10 w-10 items-center justify-center rounded-full bg-primary/20 dark:bg-primary/30">
            <span className="material-symbols-outlined text-primary dark:text-green-300">
              check_circle
            </span>
          </div>
        </div>
        ...
        <div className="shrink-0">
          <button
            ...
            className="inline-flex rounded-md bg-white dark:bg-slate-800 text-slate-400 dark:text-slate-500 hover:text-slate-500 dark:hover:text-slate-400 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:ring-offset-2 dark:focus:ring-offset-slate-800"
          >
